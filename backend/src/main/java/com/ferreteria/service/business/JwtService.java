// Ubicación: src/main/java/com/ferreteria/service/business/JwtService.java
...
public class JwtService {
    ...
    // Genera una clave segura. ¡En un entorno de producción, esto debería estar en application.yml!
