...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('Error de autenticación. Revisa tus credenciales y el ID de la compañía.');
            console.error(err);
        }
    };
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label htmlFor="tenantId" className="block text-sm font-medium text-gray-700">ID de la Compañía</label>
                        <input
                            id="tenantId"
                            type="text"
                            value={tenantId}
                            ...
                            placeholder="ej: ferreteria-el-tornillo-seguro"
                        />
                    </div>
                     <div>
